...
exe = EXE(pyz,
          ...
          a.zipfiles,
          a.datas + [('images/light/delete.png',      'src/images/light/delete.png', 'DATA'),
                     ...
                     ('images/light/new_chat.png',    'src/images/light/new_chat.png', 'DATA'),
                     ('images/light/save.png',        'src/images/light/save.png', 'DATA'),
                     ('images/light/splash_icon.png', 'src/images/light/splash_icon.png', 'DATA'),
                     ...
                     ('images/dark/new_chat.png',     'src/images/dark/new_chat.png', 'DATA'),
                     ('images/dark/save.png',         'src/images/dark/save.png', 'DATA'),
                     ('images/dark/splash_icon.png',  'src/images/dark/splash_icon.png', 'DATA'),
